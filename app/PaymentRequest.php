...
class PaymentRequest extends Model
{
    ...
    */
	...
	public function paymentsurecashBank(){
        return $this->hasOne('App\surecashBankRequest', 'payment_request_id');
    }
    /**
    ...
    public function getPaymentBank(){
        if(!empty($this->paymentOptionRate)
            ...
            }else if(strtolower($bankShortCode) == strtolower(self::BANK_SHORTCODE_surecash)){
                return surecashBankRequest::where(['payment_request_id' => $this->id])->first();
