...
use App\Banks\EBLBank\Merchant;
use App\Banks\EBLBank\Connection;
use App\Banks\EBLBank\Parser;
...
class Skypay
{
    ...
    public function Checkout($orderArray)
    {
        ...
        if ($checkout['result'] == 'SUCCESS') {
            request()->session()->put('eblskypay', $checkout);
            ...
            $checkout['redirect_url'] = $url['scheme'] . '://' . $url['host'] . $url['path'];
