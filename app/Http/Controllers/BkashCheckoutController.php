...
class BkashCheckoutController extends ProcessRequestController
{
    /*
    private $bkashUsername = "sandboxTestUser";
    private $bkashPassword = "hWD@8vtzw0";
    private $bkashAppKey = "5tunt4masn6pv2hnvte1sb5n3j";
    private $bkashAppSecret = "1vggbqd4hqk9g96o9rrrp2jftvek578v7d2bnerim12a87dbrrka";
    private $bkashBaseUrl = "https://checkout.sandbox.bka.sh/v1.0.0-beta";
    
    private $bkashUsername = "testdemo";
    private $bkashPassword = "test%#de23@msdao";
    private $bkashAppKey = "5nej5keguopj928ekcj3dne8p";
    private $bkashAppSecret = "1honf6u1c56mqcivtc9ffl960slp4v2756jle5925nbooa46ch62";
    private $bkashBaseUrl = "https://checkout.sandbox.bka.sh/v1.2.0-beta";*/
