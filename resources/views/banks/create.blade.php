                                ...
                                <div class="col-md">
                                    <form class="form-horizontal" role="form" method="POST" action="{{ route('banks.store') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('short_code') ? ' has-error' : '' }}">
                                            ...
                                            <input id="short_code" type="text" class="form-control" name="short_code" value="{{ old('short_code') }}" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('details') ? ' has-error' : '' }}">
                                            ...
                                            <textarea id="details" type="details" class="form-control" name="details" required>{{ old('details') }}</textarea>
