                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{ route('paymentOptionRates.update', ['id' => $paymentOptionRate->id]) }}">
                                {{ csrf_field() }}

                                <input name="id" type="hidden" value="{{ $paymentOptionRate->id }}" />
                                ...
                                <div class="form-group{{ $errors->has('bank_id') ? ' has-error' : '' }}">
                                    ...
                                    <select id="client_id" class="form-control" name="client_id">
                                        @foreach($clients as $client)
                                            <option value="{{ $client->id }}" {{ $client->id == $paymentOptionRate->client_id ? "selected" : "" }}>{{ $client->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('bank_id') ? ' has-error' : '' }}">
                                    ...
                                    <select id="payment_option_id" class="form-control" name="payment_option_id">
                                        @foreach($paymentOptions as $paymentOption)
                                            <option value="{{ $paymentOption->id }}" {{ $paymentOption->id == $paymentOptionRate->payment_option_id ? "selected" : "" }}>{{ $paymentOption->name }} ({{ $paymentOption->bank->short_code }})</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('paysenz_charge_percentage') ? ' has-error' : '' }}">
                                    ...
                                    <input id="paysenz_charge_percentage" type="text" class="form-control" name="paysenz_charge_percentage" value="{{ $paymentOptionRate->paysenz_charge_percentage }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('bank_charge_percentage') ? ' has-error' : '' }}">
                                    ...
                                    <input id="bank_charge_percentage" type="text" class="form-control" name="bank_charge_percentage" value="{{ $paymentOptionRate->bank_charge_percentage }}" required autofocus>
