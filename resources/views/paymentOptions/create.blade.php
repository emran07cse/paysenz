                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                            ...
                            <div class="row">
                                <div class="col-md">
                                    <form class="form-horizontal" role="form" method="POST" action="{{ route('paymentOptions.store') }}">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group{{ $errors->has('min_required_amount') ? ' has-error' : '' }}">
                                            ...
                                            <input id="min_required_amount" type="text" class="form-control" name="min_required_amount" value="{{ old('min_required_amount') }}" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('icon_url') ? ' has-error' : '' }}">
                                            ...
                                            <input id="icon_url" type="text" class="form-control" name="icon_url" value="{{ old('icon_url') }}" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('param_1') ? ' has-error' : '' }}">
                                            ...
                                            <input id="param_1" type="text" class="form-control" name="param_1" value="{{ old('param_1') }}">
                                        ...
                                        <div class="form-group{{ $errors->has('param_2') ? ' has-error' : '' }}">
                                            ...
                                            <input id="param_2" type="text" class="form-control" name="param_2" value="{{ old('param_2') }}">
